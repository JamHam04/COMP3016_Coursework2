...
Player::Player(const float* objVertices, size_t vertexCount, const unsigned int* objIndices, size_t indexCount, glm::vec3 position, float moveSpeed, glm::vec3 scaleAmount)
	: indexCount(indexCount), position(position), moveSpeed(moveSpeed), scaleAmount(scaleAmount)
{
	// Assign buffers
